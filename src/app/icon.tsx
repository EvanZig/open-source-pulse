  ...
  return new ImageResponse(
    ...
    >
      <svg width="64" height="64" viewBox="0 0 64 64" fill="none">
        ...
        <rect x="2" y="2" width="60" height="60" rx="16" fill="#11111b" stroke="url(#logo-border)" strokeWidth="2" />
        <rect x="3" y="3" width="58" height="58" rx="15" fill="rgba(255, 255, 255, 0.02)" />

        <line x1="10" y1="32" x2="54" y2="32" stroke="#313244" strokeWidth="2.5" strokeDasharray="3 3" strokeLinecap="round" />
        ...
        <circle cx="28" cy="14" r="5" fill="#cba6f7" stroke="#11111b" strokeWidth="1.5" filter="url(#node-glow)" />
        <circle cx="40" cy="50" r="5" fill="#94e2d5" stroke="#11111b" strokeWidth="1.5" filter="url(#node-glow)" />
